"""Command-line tool functionality for report."""
...
from eugene.report.checkpoint import create_workflow_hashcode
...
def main(args):
    ...
    # Run the tool.
    from eugene.report.run import run_report
    run_report(args)
    file_handler.close()
